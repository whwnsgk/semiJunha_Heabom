...
/**
 * Servlet implementation class PlaceReviewSelectController
 */
@WebServlet("/rlist.pl")
public class PlaceReviewSelectController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PlaceReviewSelectController() {
        super();
