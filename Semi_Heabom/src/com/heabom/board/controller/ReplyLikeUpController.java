...
/**
 * Servlet implementation class BoardLikeUpController
 */
@WebServlet("/likeup.bo")
public class ReplyLikeUpController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReplyLikeUpController() {
        super();
